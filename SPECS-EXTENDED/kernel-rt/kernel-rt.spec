...
make -C tools/bpf resolve_btfids
install -vsm 755 tools/bpf/resolve_btfids/resolve_btfids %{buildroot}%{_prefix}/src/linux-headers-%{uname_r}/tools/bpf/resolve_btfids
